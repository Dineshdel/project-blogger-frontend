const Footer = () => {
  return (
    <>
      <div className="mt-8 w-full bg-black py-4 px-1 md:px-[50px] flex md:flex-row flex-col space-y-6 md:space-y-0 items-start md:justify-between text-sm md:text-md">
